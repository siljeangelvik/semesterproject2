...
loadMoreButton.addEventListener("click", () => {
    ...
    fetch(`${API_LISTINGS_URL}?offset=${offset}&limit=${limit}`)
        .then(response => {
            // if the request is successful, return a list of data items
            if (response.ok) {
...
`;
        ...
        // increment the offset by the limit to prepare for the next API request
        offset += limit;
